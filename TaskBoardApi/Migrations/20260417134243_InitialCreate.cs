        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsComplered = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Tasks",
                columns: new[] { "Id", "CreatedAt", "Description", "IsComplered", "Title" },
                values: new object[,]
                {
                    ...
                    { 3, new DateTime(2026, 1, 3, 0, 0, 0, 0, DateTimeKind.Utc), "HTML, CSS, JavaScript, fecth", false, "Написать фронтенд" },
